...
public class TestUser {
	...
	public static void main(String[] args) {
		...
		liste = pdao.findAll();
		System.out.println("Les personnes après ajout de adresse : " + a5);
		System.out.println(liste); //on remarque que la personne p3 à bien été ajouté malgré qu'elle n'est pas en persisté en BDD (bidirectionnel)
		...
		u2.getListeAddresses().remove(a3);
		try {
			adao.delete(a3);
		} catch (Exception e) {
			e.printStackTrace();
